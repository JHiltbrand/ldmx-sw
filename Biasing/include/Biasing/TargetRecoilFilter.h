...
#ifndef BIASING_TARGETRECOILFILTER_H_
#define BIASING_TARGETRECOILFILTER_H_
...
//#include "Biasing/TargetRecoilFilterMessenger.h"

namespace ldmx {

    //class TargetRecoilFilterMessenger; 

    class TargetRecoilFilter : public UserActionPlugin {
        ...
        private:
            ...
            //TargetRecoilFilterMessenger* messenger_{nullptr};
...
#endif // BIASING_TARGETRECOILFILTER_H__
